...
const sendEmailtoUser =async (link, receiverEmail,subject,text) => {
                                    ...
                                    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td style="padding:0 35px;">
                                                ...
                                                <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">${text}</p>
                                                <a href=${link}
  ...
  await transport.sendMail(mailOptions, (error, info) => {
    ...
    return res.status(200).json({ message: "Signup successful. An Email is sent to verify your account. Please verify it." });
  });
};
